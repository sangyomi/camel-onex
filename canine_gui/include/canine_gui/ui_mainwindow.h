...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox_camera->setGeometry(QRect(1310, 0, 350, 286));
        CAMERA = new QLabel(groupBox_camera);
        CAMERA->setObjectName(QString::fromUtf8("CAMERA"));
        CAMERA->setGeometry(QRect(15, 34, 320, 240));

        groupBox_gps = new QGroupBox(centralwidget);
        groupBox_gps->setObjectName(QString::fromUtf8("groupBox_gps"));
        groupBox_gps->setGeometry(QRect(1310, 293, 350, 367));
        GRID_MAP = new QLabel(groupBox_gps);
        GRID_MAP->setObjectName(QString::fromUtf8("GPS"));
        GRID_MAP->setGeometry(QRect(15, 34, 330, 330));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        groupBox_camera->setTitle(QApplication::translate("MainWindow", "CAMERA", nullptr));
        CAMERA->setText(QApplication::translate("MainWindow", "Camera", nullptr));

        groupBox_gps->setTitle(QApplication::translate("MainWindow", "GPS", nullptr));
        GRID_MAP->setText(QApplication::translate("MainWindow", "Gps", nullptr));
    } // retranslateUi
